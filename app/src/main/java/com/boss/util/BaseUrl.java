...
//    public static String Post_Video_Url = "http://logicaltest.in/Exim_papa/assets/video/";
    ...
    public static final String delete_reel_comment = "delete_reel_comment";
    public static final String share_reel = "share_reel";
    public static final String view_reel = "view_reel";
    public static final String like_unlike_reel_main_comment = "like_unlike_reel_main_comment";
